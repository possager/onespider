#_*_coding:utf-8_*_
from onespider import myPageStucture
import re
import pickle
import MySQLdb
import pymongo
...
mongo_client=pymongo.MongoClient('localhost',port=27017)
mongo_COL=mongo_client['xpath1']
mongo_DOC=mongo_COL['allxpath1']
...
def deal_response(response):
    ...
    # print thisclass
    # mongo_DOC.insert(thisclass_dict)#其实在后边的getresult需要的就是字典中的list
    # return thisclass
